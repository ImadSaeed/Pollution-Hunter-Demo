...
# Works for both private and public repos with src/ folder structure
...
with st.sidebar:
    ...
    default_index = cities.index('Islamabad') if 'Islamabad' in cities else 0
    city = st.selectbox("🏙️ Select City", cities, index=default_index)
